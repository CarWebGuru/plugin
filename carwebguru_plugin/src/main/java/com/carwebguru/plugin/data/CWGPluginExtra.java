...
public class CWGPluginExtra extends CWGPluginAbstractData {
    ...
    private final CWGVar supportedValue;
    ...
    public CWGPluginExtra() {
        ...
        apiKey = createVar(CWGPluginConst.Keys.API_HASH, "");

        supportedValue = createVar(CWGPluginConst.Keys.SUPPORTED_VALUE, true, true);
    ...
    public boolean isSupportedValue() {
        return supportedValue.isValueBool();
    }
    ...
    public void setSupportedValue(boolean value) {
        supportedValue.setValueBool(value);
    }
