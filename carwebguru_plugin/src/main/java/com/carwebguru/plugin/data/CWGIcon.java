...
public class CWGIcon {
    ...
    public void loadFromIntent(Intent intent) {
        ...
        switch (getIconType()) {
            ...
            case CWGPluginConst.IconTypes.ICON_CODE:
                libraryCode.loadFromIntent(intent);
                break;

            case CWGPluginConst.IconTypes.ICON_BITMAP:
    ...
    public boolean isLibraryIcon() {
        return getIconType() == CWGPluginConst.IconTypes.ICON_CODE;
    }

    public boolean isBitmapIcon() {
        return getIconType() == CWGPluginConst.IconTypes.ICON_BITMAP;
    }
    ...
    public void setLibraryCode(int iconLibraryCode) {
        ...
        iconType.setValueInt(CWGPluginConst.IconTypes.ICON_CODE);
    }
    ...
    public void setIconBitmap(Bitmap bmp) {
        this.bitmap = bmp;
        iconType.setValueInt(CWGPluginConst.IconTypes.ICON_BITMAP);
    }
...
/*
    String str = new Character((char) values.getIconLibraryCode()).toString();
    return str;
 */